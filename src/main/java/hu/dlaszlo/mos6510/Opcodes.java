...
public class Opcodes {
    ...
    static {
        ...
        opcodeList.add(new Opcode(0x10, BPL, REL, 2, 2, 3, "bpl $$REL"));
        opcodeList.add(new Opcode(0x30, BMI, REL, 2, 2, 3, "bmi $$REL"));
        opcodeList.add(new Opcode(0x50, BVC, REL, 2, 2, 3, "bvc $$REL"));
        opcodeList.add(new Opcode(0x70, BVS, REL, 2, 2, 3, "bvs $$REL"));
        opcodeList.add(new Opcode(0x90, BCC, REL, 2, 2, 3, "bcc $$REL"));
        opcodeList.add(new Opcode(0xb0, BCS, REL, 2, 2, 3, "bcs $$REL"));
        opcodeList.add(new Opcode(0xd0, BNE, REL, 2, 2, 3, "bne $$REL"));
        opcodeList.add(new Opcode(0xf0, BEQ, REL, 2, 2, 3, "beq $$REL"));
